...
| [Tagging — real-world](pipelines/tagging-real-world.html) | Defensive build script for legacy LaTeX → PDF/UA-1 or PDF/UA-2 (default UA-2) without modifying the originals |
